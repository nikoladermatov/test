...
public class TMW_OPTIMA_419_016 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_016");

	@Test
	public void Optima419_016() throws Exception {
		...
		//Test execution
		logger.info("######################          Executing TMW_OPTIMA_419_016 test          ######################");
		
		//Verification of :	
		logger.info("TMW_OPTIMA_419_016 with Non-General Deposit and Payment Method- Direct debit");
...
//		HomePage.goTo();
		...
		Request.addPayload(propconfig.getProperty("TMW_OPTIMA_419_016_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_016 test is completed!      ######################");
	}
}
