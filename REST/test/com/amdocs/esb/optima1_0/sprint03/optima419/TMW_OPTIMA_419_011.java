...
public class TMW_OPTIMA_419_011 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_011");

	@Test
	public void Optima419_011() throws Exception {
		...
		//Test execution:
		logger.info("######################          Executing TMW_OPTIMA_419_011 test          ######################");
		
		//Verification of :	
		logger.info("TMW_OPTIMA_419_011 with General Deposit,Payment Method- Credit Card and no Manual Credit Card Authorization Code_Date");
...
//		HomePage.goTo();
		...
		Request.addPayload(propconfig.getProperty("TMW_OPTIMA_419_011_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_011 test is completed!      ######################");
	}
}
