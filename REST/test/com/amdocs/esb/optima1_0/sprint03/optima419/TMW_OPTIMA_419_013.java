...
public class TMW_OPTIMA_419_013 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_013");

	@Test
	public void Optima419_013() throws Exception {
		...
		//Test execution:
		logger.info("######################          Executing TMW_OPTIMA_419_013 test          ######################");
		
		//Verification of :	
		logger.info("TMW_OPTIMA_419_013 with General Deposit,Payment Method- Credit Card regular flow");
...
//		HomePage.goTo();
		...
		Request.addPayload(propconfig.getProperty("TMW_OPTIMA_419_013_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_013 test is completed!      ######################");
	}
}
