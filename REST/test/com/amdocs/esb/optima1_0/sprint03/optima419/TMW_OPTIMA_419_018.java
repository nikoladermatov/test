...
public class TMW_OPTIMA_419_018 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_018");

	@Test
	public void Optima419_018() throws Exception {
		...
		//Test execution
		logger.info("######################          Executing TMW_OPTIMA_419_018 test          ######################");
		
		//Verification of :	
		logger.info("TMW_OPTIMA_419_018 with Non-General Deposit and Negative Amount");
...
//		HomePage.goTo();
		...
		Request.addPayload(propconfig.getProperty("TMW_OPTIMA_419_018_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_018 test is completed!      ######################");
	}
}
