...
public class TMW_OPTIMA_419_012 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_012");
	...
	@Test
	public void Optima419_012() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_012_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_012_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_012 test is completed!      ######################");
