...
public class TMW_OPTIMA_419_017 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_017");
	...
	@Test
	public void Optima419_017() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_017_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_017_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_017 test is completed!      ######################");
