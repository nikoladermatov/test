...
public class TMW_OPTIMA_419_008 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_008");
	...
	@Test
	public void Optima419_008() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_008_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_008_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_008 test is completed!      ######################");
