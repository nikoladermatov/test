...
public class TMW_OPTIMA_419_006 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_006");
	...
	@Test
	public void Optima419_006() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_006_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_006_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_006 test is completed!      ######################");
