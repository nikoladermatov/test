...
public class TMW_OPTIMA_419_005 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_005");
	...
	@Test
	public void Optima419_005() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_005_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_005_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_005 test is completed!      ######################");
