...
public class TMW_OPTIMA_419_014 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_014");
	...
	@Test
	public void Optima419_014() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_014_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_014_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_014 test is completed!      ######################");
