...
public class TMW_OPTIMA_419_009 {

	Logger logger = Logger.getLogger("TMW_OPTIMA_419_009");
	...
	@Test
	public void Optima419_009() throws Exception {
		...
		Request.addURL(prop.getProperty("TMW_OPTIMA_419_009_URL"));
		Request.addPayload(prop.getProperty("TMW_OPTIMA_419_009_Payload"));
		...
		logger.info("######################          TMW_OPTIMA_419_009 test is completed!      ######################");
