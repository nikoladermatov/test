...
public class TMW_OPTIMA_466_001 {
	...
	Logger logger = Logger.getLogger("TMW_OPTIMA_466_001");
	...
	@Test
	public void Optima466_001() throws Exception {
		...
		//Set Basic Summary Fields for validation
			String[] basicSummaryFields  = propconfig.get("bsf466").toString().split(",");
		//Set Embed Fields for validation
			String[] embedParameterFields  = propconfig.get("emb466").toString().split(",");
		...
		//Test execution
		logger.info("######################          Executing TMW_OPTIMA_466_001 test          ######################");
		...
		logger.info("######################          TMW_OPTIMA_466_001 test is completed!      ######################");
	}
}